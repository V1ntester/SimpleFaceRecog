...
#Persons
persons = ['Valentin Nikandrov | Author', 'Vladislav Yatsuk | Teacher of additional education IT quantum', 'Dmitriy Krivoguzov | Director of DT "Quantorium" Velikiye Luki', 'Alina Kondratieva | Educator-organizer', 'Ekaterina Golyashkina | Additional education teacher Promrobokvantum', 'Ekaterina Pentyushenko | Head project management sector', 'Elena Kovaleva | Director of UIA BIN']
